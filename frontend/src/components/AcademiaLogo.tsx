  ...
  return (
    <div className={`flex items-center gap-3 select-none ${className}`}>
      ...
      >
        ...
        <path d="M32 12L54 24L32 36L10 24L32 12Z" fill="url(#primaryGrad)" />
        ...
        {/* Dynamic Verification Tassel & Indicator Node */}
        <path
          d="M48 27V42"
          stroke="url(#cyanGrad)"
          strokeWidth="2.5"
          strokeLinecap="round"
        />
        <circle cx="48" cy="44.5" r="3.5" fill="#06B6D4" />
      ...
      {showText && (
        <div className="flex flex-col justify-center leading-none">
          <div className="text-xl font-black tracking-tight text-slate-900 dark:text-white">
            Academia<span className="bg-gradient-to-r from-indigo-600 to-cyan-500 bg-clip-text text-transparent">Edu</span>
          </div>
          <span className="text-[9px] font-extrabold uppercase tracking-[0.2em] text-slate-400 dark:text-slate-500 mt-0.5">
